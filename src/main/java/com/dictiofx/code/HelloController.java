...
public class HelloController {
    ...
    protected void listOfWords() {
        ...
        listeDeMots.addAll(dictionnaire.mots().keySet());
        Collections.sort(listeDeMots);

        for (String s : listeDeMots){
    ...
    public void chercher() {
        ...
        search.textProperty().addListener((_, _, newValue) -> {
            ...
            for (String mot : listeFiltre) {
                ...
                bouton.setBackground(searchList.getBackground());
